...
4. The recursive methods getProfileConnections() and getAllConnections() should be used with care! The overuse and abuse of 4. the recursive methods getProfileConnections() and getAllConnections() may cause issues with LinkedIn. 
